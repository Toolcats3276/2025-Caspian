...
public class SuckOut extends SequentialCommandGroup{



    public SuckOut(WristSS s_Wrist, ArmSS s_Arm, ElevatorSS s_Elevator, InfeedSS s_Infeed, SensorSS s_Sensor) {
