...
public class AlgaeInfeedL2FrontCoCommand extends SequentialCommandGroup{



    public AlgaeInfeedL2FrontCoCommand(WristSS s_Wrist, ArmSS s_Arm, ElevatorSS s_Elevator, InfeedSS s_Infeed, SensorSS s_Sensor) {
