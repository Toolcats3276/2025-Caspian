...
public class AlgaeInfeedL1FrontCoCommand extends SequentialCommandGroup{



    public AlgaeInfeedL1FrontCoCommand(WristSS s_Wrist, ArmSS s_Arm, ElevatorSS s_Elevator, InfeedSS s_Infeed, SensorSS s_Sensor) {
        ...
        addCommands(
             new ParallelCommandGroup(
                ...
                new ElevatorPIDCommand(s_Elevator, ElevatorConstants.ALGAE_INFEED_L1_Front, ElevatorConstants.MAX_PID_OUTPUT),
