...
public class AlgaeInfeedL1BackSensorCoCommand extends SequentialCommandGroup{



    public AlgaeInfeedL1BackSensorCoCommand(WristSS s_Wrist, ArmSS s_Arm, ElevatorSS s_Elevator, InfeedSS s_Infeed, SensorSS s_Sensor) {
