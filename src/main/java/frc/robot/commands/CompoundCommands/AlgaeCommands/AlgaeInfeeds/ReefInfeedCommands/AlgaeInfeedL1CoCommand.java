...
public class AlgaeInfeedL1CoCommand extends SequentialCommandGroup{



    public AlgaeInfeedL1CoCommand(WristSS s_Wrist, ArmSS s_Arm, ElevatorSS s_Elevator, InfeedSS s_Infeed, SensorSS s_Sensor) {
