...
public class AlgaeInfeedL2SensorFrontCoCommand extends SequentialCommandGroup{

    private boolean endCommand = false;

    public AlgaeInfeedL2SensorFrontCoCommand(WristSS s_Wrist, ArmSS s_Arm, ElevatorSS s_Elevator, InfeedSS s_Infeed, SensorSS s_Sensor) {
